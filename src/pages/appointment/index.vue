...
export default {
    ...
    methods: {
        ...
        testAddList() {
            let markerInfoList = [
                {
                    id: "10001", url: "src\pages\appointment\img\银行.png", title: "网点1", content: "当前网点预约人数", lng: 115.83069930916683, lat: 28.67036966457041
                },
                {
                    id: "10002", url: "src\pages\appointment\img\银行.png", title: "网点2", content: "当前网点预约人数", lng: 115.91657637048775, lat: 28.688846961648085
                }
            ];
        ...
        taransResponse(list) {
            ...
            for (let i = 0; i < list.length; i++) {
                let info = { id: 0, url: "src\pages\appointment\img\银行.png", title: 0, content: 0, lng: 0, lat: 0 };
                info.id = list[i].id;
